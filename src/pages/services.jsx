...
const services = [
  {
    title: "Site vitrine",
    subtitle: "Présenter votre activité avec clarté",
    description:
  ...
  },
  {
    ...
    subtitle: "Modifier vos contenus sans toucher au code",
    description:
  ...
  },
  {
    ...
    subtitle: "Créer un outil adapté à un besoin précis",
    description:
...
const Services = () => {
  return (
    <main className="services-page">
      ...
      <section className="services-grid" aria-label="Liste des services">
