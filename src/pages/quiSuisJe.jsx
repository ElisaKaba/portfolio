...
const QuiSuisJe = () => {
  return (
    <main className="qui-suis-je-page">
      <section className="qui-suis-je-layout">
        <div className="qui-suis-je-photo-wrapper">
          <img
            src="/img/photoElisa.jpg"
            alt="Portrait d’Elisa Kaba"
            className="qui-suis-je-photo"
          />
        </div>

        <div className="qui-suis-je-card">
          <p className="qui-suis-je-label">Qui suis-je ?</p>

          <h1>Développeuse frontend, sensible à l’UX/UI et aux usages humains</h1>

          <div className="qui-suis-je-text">
            <p>
            ...
            <p>
              En 2021, j’ai choisi de faire de mon intérêt pour l’informatique un métier.
              J’ai d’abord suivi une formation de développeuse frontend chez
              OpenClassrooms, puis j’ai complété mon parcours avec une formation de
              développeuse d’applications, me permettant de travailler avec des
              technologies comme React, Angular, JavaScript, Java et les bases de données.
            </p>
          ...
          <div className="qui-suis-je-actions">
            <NavLink
              className="qui-suis-je-button qui-suis-je-button-contact"
              to="/contact"
            >
            ...
            <a
              className="qui-suis-je-button qui-suis-je-button-cv"
              href="/cvElisa.pdf"
